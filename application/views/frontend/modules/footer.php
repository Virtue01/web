<footer id="footer" style='padding-bottom:80px'>
    ...
    <div class="container">
        <div class="col-xs-12 col-sm-4">
                <a href="trang-chu">
                    <img src="public/images/v2.png" style="width: 80%;" class="img-fix f-logo" alt="smart-construction">
                </a>
            ...
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Quang Trung - Thái Nguyên</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0788220158</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:alitrumcuoi@gmail.com">daovanhieu208@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
